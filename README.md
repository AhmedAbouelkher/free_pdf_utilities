...
A totally free, open source and simple [Flutter](https://flutter.dev) desktop app with a set of tools to manipulate PDF files for FREE.
...
- This app currently being developed and tested only on macOS, if you have any problem/bugs running the app on your machine, open an [issue](https://github.com/AhmedAbouelkher/free_pdf_utilities/issues) to address the solutions.
